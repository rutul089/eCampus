...
public class BadgedTabLayout extends TabLayout {
    ...
    public BadgedTabLayout(Context context, AttributeSet attrs) {
        ...
        badgeBackgroundColors = ContextCompat.getColorStateList(context, R.color.colorWhite);
        badgeTextColors = ContextCompat.getColorStateList(context, R.color.colorPrimary);
